...
class _FingerAdditionAppState extends State<FingerAdditionApp>
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/game': (_) => const GameMenuScreen(),
        '/animal_game': (_) => const AnimalGameScreen(),
        '/fruits_game': (_) => const FruitGameScreen(),
        '/things_game': (_) => const ThingGameScreen(),
        '/mixed_game': (_) => const MixedGameScreen(),
      },
    );
  }
}
